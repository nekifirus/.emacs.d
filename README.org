...
#+BEGIN_SRC emacs-lisp
  (use-package faces
    ...
    :defer t
    :custom
    (face-font-family-alternatives '(("Monaco" "Iosevka Light" "Source Code Pro Light" "Ubuntu" "Monaco" "Consolas" "Monospace")))
    :config
...
#+end_SRC
    (set-face-attribute 'default
                        ...
                        ;; :height (/ (* 20 (display-pixel-height)) (display-mm-height))
                        ;; :height (if (> (display-pixel-height) 1079) 130 160)
                      :height 130
                      )
